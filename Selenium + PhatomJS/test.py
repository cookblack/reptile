...
chromedriver = "D:\Reptile\chromedriver_win32\chromedriver.exe"

driver = webdriver.Chrome(chromedriver)  # 指定使用的浏览器，初始化webdriver 指定驱动

urlw = "http://www.python.org"
driver.get(urlw)  # 请求网页地址
