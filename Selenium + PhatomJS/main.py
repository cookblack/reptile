...
class AlbumCover():
    ...
    def __init__(self):
        self.init_url = "http://music.163.com/#/artist/album?id=98351&limit=12&offset=0" #请求网址
        self.folder_path = "d:\TheBeatles" #想要存放的文件目录
    ...
    def spider(self):
        print("Start!")
        driver = webdriver.PhantomJS(executable_path=r'D:\Reptile\phantomjs-2.1.1-windows\bin\phantomjs.exe')
