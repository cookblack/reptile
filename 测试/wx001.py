...
class BeautifulPicture():
    ...
    def __init__(self):  #类的初始化操作
        ...
        self.web_url = 'https://mp.weixin.qq.com/s/vHq09ExVR_XMSR3l8z9YcA'  #要访问的网页地址
        self.folder_path = 'D:\BeautifulPicture\wx'  #设置图片要存放的文件目录

    def get_pic(self):
        print('开始网页get请求')
        r = self.request(self.web_url)
        print('开始获取所有img标签')
        all_a = BeautifulSoup(r.text, 'lxml').find_all('img') #获取网页中的class为cV68d的所有a标签 , '[data-s="300,640"]'
        print(all_a)
        print('开始创建文件夹')
